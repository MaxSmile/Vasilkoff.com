        ...
        <div className="overflow-x-hidden">
                    ...
                    <div className="container">
                        <div className="relative pt-14 pb-0 lg:pt-20 lg:pb-40 xl:pt-36">
                            <div className="relative text-center ">
                                ...
                                <p className="pb-10 mt-20 text-lg font-semibold leading-[30px]"
                                >
                                ...
                                <Link href="/#talkToUs" className="btn mx-auto mt-2 block w-fit text-light"
                                >
                                    talk to us
                                </Link>
                            </div>
            ...
            <section className="bg-[url(/assets/images/service-bg.png)] bg-cover bg-center bg-no-repeat py-14 dark:bg-none lg:py-[100px]">
                <Container className="space-y-8">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <ServiceCardOne title="UI/UX Design" message="Simplify your digital journey with our expert UI/UX design services. Our team 
                            creates designs that are both beautiful and functional, delivering a seamless and engaging user experience that captures your audience's attention."
                            icon={<PhoneFill className="text-light"/>} />

                        <ServiceCardOne title="Web Development" message="Our team works with a variety of front-end and back-end technologies, CMS, including WordPress, and specializes in 
                            major eCommerce platforms like Magento and Shopify."
                            icon={<PhoneFill className="text-light"/>} />

                        <ServiceCardOne title="Mobile Apps Development" message="Our team specializes in both native app development and Flutter, 
                            delivering customized solutions that are tailored to your unique business needs."
                            icon={<PhoneFill className="text-light"/>} />
                    </div>
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="container">
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="group cursor-pointer text-center">
                            ...
                            <h6 className="text-sm font-bold">Chief Business Development Officer</h6>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gradient-to-b from-white/60 to-transparent py-14 dark:from-white/[0.02] lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center">
                        <h6>Pricing</h6>
                        <h4>Competitive rates for superior service</h4>
                    </div>
