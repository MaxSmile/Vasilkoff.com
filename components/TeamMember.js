    ...
    return (
        <div className="group text-center"><Link href={link}>
            <div className="relative md:h-[180px] h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                <Image loading="lazy" width={200} height={180} src={picture} alt={name} className="h-full w-full rounded-3xl object-cover object-top grayscale transition duration-200 group-hover:grayscale-0" />
            </div>
