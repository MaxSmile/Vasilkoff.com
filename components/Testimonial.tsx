        ...
        <section className={`relative bg-black py-14 dark:bg-transparent lg:py-[100px] ${className}`}>
            {type.toLowerCase() === 'common' && (
                <div className="absolute top-0 right-0">
                    <svg role="presentation"  width="758" height="741" viewBox="0 0 758 741" fill="none">
                        <g opacity="0.03">
                            <ellipse
                                opacity="0.1"
                                cx="752"
            ...
            {type.toLowerCase() === 'modern-saas' && (
                <div>
                    <div className="absolute top-0 left-1/4">
                        <svg role="presentation"  width="191" height="66" viewBox="0 0 191 66" fill="none">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                    ...
                    <div className="absolute top-1/4 hidden right-4 lg:block">
                        <svg role="presentation"  width="301" height="322" viewBox="0 0 301 322" fill="none">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                ...
                <div className={`mx-auto ${type.toLowerCase() === 'common' ? 'lg:w-11/12' : ''} `}>
                    <div className="relative sm:py-12 md:py-0">
                                            ...
                                            <div className="items-center gap-4 sm:grid sm:grid-cols-3">
                                                <div className="col-span-2">
                                                    <div className="relative rounded-3xl bg-white/[0.02] p-6">
                                                        ...
                                                        />
                                                        <div className="pb-8">
                                                            <svg role="presentation"  width="96" height="16" viewBox="0 0 96 16" fill="none">
                                                                <path
                                            ...
                                            <div className="mb-6 flex flex-col items-center justify-between gap-6 md:mb-14 md:flex-row">
                                                <div className="relative rounded-3xl bg-white/[0.02] p-6 md:w-2/3 lg:w-1/2">
                                                    <div className="absolute right-4 top-4">
                                                        <svg role="presentation"  width="90" height="73" viewBox="0 0 90 73" fill="none">
                                                            <g opacity="0.05">
                                                                <path
                        ...
                        >
                            ...
                            >
                                <svg role="presentation"  width="7" height="12" viewBox="0 0 7 12" fill="none">
                                    <path
