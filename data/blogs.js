const blogs = {
    "empowering-ai-saas-web-development": {
...
Outsourcing AI software development comes with its unique set of challenges. These include finding the right expertise, ensuring data security, and managing project complexities. Vasilkoff not only recognizes these challenges but also offers innovative solutions to overcome them, as explored in our [Common Challenges and Solutions in Outsourcing AI Software Development](https://vasilkoff.com/blog/challenges-and-solutions) blog post. Our strategies involve meticulous planning, rigorous security protocols, and the flexibility to adapt to project-specific needs, ensuring a smooth and successful outsourcing experience.
...
`
    ...
    "hackadtech": {
        ...
        "time": "4 min",
        "content": `## Pioneering Integration: AI and Social Media
...
`
    ...
    "boc-hackathon-4-0":{
      ...
      "time": "3 min",
      "content":`## Journey Through Hackathons
---
