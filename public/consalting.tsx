                            ...
                            <div className="pt-14 pb-8 text-center text-white lg:w-3/5 lg:py-20 lg:text-left">
                                <div className="mb-10 inline-flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3.5">
                                    <div className="inline-flex items-center gap-1">
                                        <svg role="presentation"  width="14" height="13" viewBox="0 0 14 13" fill="none">
                                            <path
                        ...
                        <div className="mt-16 grid gap-x-7 gap-y-12 text-lg font-semibold sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-20">
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                <div className="h-10 w-10 flex-none text-black dark:text-white">
                                    <svg role="presentation"  width="40" height="40" viewBox="0 0 40 40" fill="none"  >
                                        <path
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                <div className="h-10 w-10 flex-none text-black dark:text-white">
                                    <svg role="presentation"  width="34" height="37" viewBox="0 0 34 37" fill="none"  >
                                        <path
                                        ...
                                        <ul className="space-y-8 text-lg font-semibold text-white">
                                            <li className="flex items-center gap-3.5">
                                                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary">
                                                    <svg role="presentation"  width="12" height="9" viewBox="0 0 12 9" fill="none"  >
                                                        <path
                            ...
                            <div className="relative text-center md:w-1/2 md:text-left xl:pr-12">
                                ...
                                <form className="relative mt-14">
                                    <div className="absolute top-1/2 -translate-y-1/2 pl-4">
                                        <svg role="presentation"  width="25" height="21" viewBox="0 0 25 21" fill="none"  >
                                            <path
